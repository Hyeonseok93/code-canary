...
resource "aws_security_group" "data" {
  ...
  description = "RDS and Redis from ECS"
  vpc_id      = aws_vpc.this.id
...
resource "aws_vpc_security_group_ingress_rule" "data_postgres_from_ecs" {
...
resource "aws_vpc_security_group_ingress_rule" "data_redis_from_ecs" {
  security_group_id            = aws_security_group.data.id
